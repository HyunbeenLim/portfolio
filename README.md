...
그렇기에 모수적 방법을 사용하여 다시 분석을 하였고 상관분석에 Pearson correlation 방법을, 평균분석에 T-test/ANOVA를 사용하였습니다.
...
문항 별로 해당 문항 제거시 alpha 값 또한 구해보았는데, alpha 값이 소폭 상승하는 문항들이 있었지만 이에 대해 다시한번 Nunally가 언급한 내용을 바탕으로 제거할만한 점수 상승량은 아니라고 판단하였습니다(alpha inflation 등의 이유로 고려할 사항이 많아 제거하는 것이 언제나 좋은 것은 아니라고 하였습니다).
